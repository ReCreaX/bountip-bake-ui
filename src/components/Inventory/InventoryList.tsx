...
export default function InventoryList() {
  ...
  const SortableHeader = ({
    ...
    <th
      className="pl-2 py-3 text-left text-xs font-normal text-[#737373] uppercase tracking-wider cursor-pointer hover:bg-gray-50"
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {sortedItems.map((item, index) => (
                <tr key={`${item.id}-${index}`} className="hover:bg-gray-50">
                  <td className="px-6 py-4 truncate whitespace-nowrap text-sm font-medium text-[#15BA5C]">
                    {item.id}
                  </td>
                  <td className="px-6 py-4  truncate whitespace-nowrap text-sm font-normal text-[#1E1E1E]">
                    {item.itemName}
                  </td>
                  <td className="px-6 py-4 truncate whitespace-nowrap text-sm text-[#1E1E1E]">
                    {item.category}
                  </td>
                  <td className="px-6 py-4 truncate whitespace-nowrap text-sm text-[#1E1E1E]">
                    {item.quantity}
